CLASS zcl_mcbc_output_adt DEFINITION
  PUBLIC
  ...
  PRIVATE SECTION.
    DATA mo_out TYPE REF TO if_oo_adt_intrnl_classrun.

ENDCLASS.



CLASS ZCL_MCBC_OUTPUT_ADT IMPLEMENTATION.
  ...
  METHOD if_oo_adt_intrnl_classrun~begin_section.
    ...
    me->mo_out->begin_section( title = title ).
    output = me.
